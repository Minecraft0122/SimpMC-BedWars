...
public class English extends Language {
    ...
    public English() {
        ...
        addContentMessages(yml, "self-rescue-platform", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Self-Rescue Platform", Arrays.asList("&7Cost: {cost} {currency}", "", "&7Deploys a temporary slime platform", "&7to save you from the void.", "", "{quick_buy}", "{buy_status}"));
