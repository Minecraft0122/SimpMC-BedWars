...
本教程对应 SimpMC-BedWars `2.x`，目标运行环境是 **Paper 1.21.11 + Java 21**。其他 Minecraft 版本、Spigot、Folia 和旧版 Java 不在支持范围内。仓库面向维护者和服主的说明、Issue/PR 模板及工作流显示文本均使用中文。
...
- 版本号遵循语义化版本：兼容修复递增最后一位，兼容新功能递增中间一位，不兼容变化递增第一位。
